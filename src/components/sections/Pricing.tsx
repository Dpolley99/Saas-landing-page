          ...
          {pricingPlans.map((plan, key) => (
            <div key={key} className="relative group h-full">
              <div className="bg-linear-to-r from-blue-600 to-violet-600 p-1 rounded-3xl h-full">
                ...
                >
                  {plan.bestValue && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primarytext-white text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-linear-to-r from-blue-600 to-violet-600">
                      Best Value
                    </div>
                  )}
